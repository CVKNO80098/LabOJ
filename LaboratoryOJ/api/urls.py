...
from . import admin
from .views import RegisterView, LoginView, LogoutView, ProblemListView, ProblemDetailView, SubmissionCreateView, \
    SubmissionDetailView, LeaderboardView, judge_code
